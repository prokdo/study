...
data class Genotype(val data: IntArray) : Iterable<Int> {
    ...
    fun clone(): Genotype = Genotype(this.data.clone())
    ...
    override fun toString(): String {
        ...
        this.data.forEachIndexed { index, value ->
            run {
                ...
                if (index != this.data.size - 1) builder.append(" ") else builder.append("]")
            }
        }
