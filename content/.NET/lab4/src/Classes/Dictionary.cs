...
public class Dictionary<TKey, TValue> : IDictionary<TKey, TValue>
{
    ...
    public event ICollection<KeyValuePair<TKey, TValue>>.AddEventHandler? AddEvent;
    public event ICollection<KeyValuePair<TKey, TValue>>.RemoveEventHandler? RemoveEvent;
    public event ICollection<KeyValuePair<TKey, TValue>>.CopyToEventHandler? CopyToEvent;
    public event ICollection<KeyValuePair<TKey, TValue>>.ClearEventHandler? ClearEvent;
    ...
    public void Add(TKey key, TValue value)
    {
        ...
        AddEvent?.Invoke(this, new AddEventArgs<KeyValuePair<TKey, TValue>>(new KeyValuePair<TKey, TValue>(key, value)));
    }
    ...
    {
        CopyToEvent?.Invoke(this, new CopyToEventArgs<KeyValuePair<TKey, TValue>>(array, arrayIndex));
    ...
    public bool Remove(TValue item)
    {
        ...
        {
            RemoveEvent?.Invoke(this, new RemoveEventArgs<KeyValuePair<TKey, TValue>>(new KeyValuePair<TKey, TValue>(this.Begin.Key, this.Begin.Value)));
        ...
        else
        {
            ...
            while (enumerator.MoveNext())
            {
                ...
                {
                    RemoveEvent?.Invoke(this, new RemoveEventArgs<KeyValuePair<TKey, TValue>>(new KeyValuePair<TKey, TValue>(((Entry<TKey, TValue>)enumerator.Current).Next.Key, ((Entry<TKey, TValue>)enumerator.Current).Next.Value)));
    ...
    public bool Remove(KeyValuePair<TKey, TValue> item)
    {
        ...
        else if (this.Begin.Key.Equals(item.Key) && this.Begin.Value.Equals(item.Value))
        {
            ...
            RemoveEvent?.Invoke(this, new RemoveEventArgs<KeyValuePair<TKey, TValue>>(item));
