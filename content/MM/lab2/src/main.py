...
from substance_transfer import central_difference_scheme, cabare_scheme, right_corner_scheme, cross_scheme, solve, linear_combination_solve
...
if __name__ == '__main__':
    ...
    D: float = 0                # Коэффициент диффузии
    ...
    assert v * dt / dx <= 1,            "Число Куранта слишком велико"
    if D != 0: assert v * dx / D <= 1,  "Число Перкле слишком велико"
    ...
    plt.plot(x, c_right, label='Схема «правого уголка»', linestyle=(0, (1, 1)))
